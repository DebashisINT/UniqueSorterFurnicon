...
import com.furniconbreeze.app.utils.FileLoggingTree
...
//                .tag(getString(R.string.global_tag))                   // Specify TAG, default: "X-LOG"
            ...
            //val filePrinter = FilePrinter.Builder(File(getExternalStorageDirectory(), "xfurniconbreezelogsample").path)// Printer that print the log to the file system
            val filePrinter = FilePrinter.Builder(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfurniconbreezelogsample").path)// Printer that print the log to the file system
