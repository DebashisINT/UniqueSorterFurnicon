package com.furniconbreeze.features.logoutsync.presentation
...
import com.furniconbreeze.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.furniconbreeze.features.billing.api.AddBillingRepoProvider
import com.furniconbreeze.features.billing.model.AddBillingInputParamsModel
...
import com.furniconbreeze.features.dashboard.presentation.ReasonDialog
...
import com.furniconbreeze.features.document.model.AddEditDocumentInputParams
import com.furniconbreeze.features.document.model.DocumentAttachmentModel
...
import com.furniconbreeze.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.furniconbreeze.features.orderhistory.model.*
...
import com.furniconbreeze.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.furniconbreeze.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.furniconbreeze.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.furniconbreeze.features.timesheet.model.AddTimeSheetInputModel
import com.furniconbreeze.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.furniconbreeze.features.viewAllOrder.model.AddOrderInputParamsModel
import com.furniconbreeze.features.viewAllOrder.model.AddOrderInputProductList
...
import com.furniconbreeze.MySingleton
...
import com.furniconbreeze.features.addshop.presentation.ShopExtraContactReq
...
import com.furniconbreeze.features.login.model.GetConcurrentUserResponse
import com.furniconbreeze.features.login.model.WhatsappApiData
import com.furniconbreeze.features.orderITC.SyncOrd
import com.furniconbreeze.features.orderITC.SyncOrdProductL
...
import com.furniconbreeze.features.returnsOrder.ReturnProductList
import com.furniconbreeze.features.returnsOrder.ReturnRequest
import com.furniconbreeze.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfurniconbreezelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfurniconbreezelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xfurniconbreezelogsample/log.zip").path);
